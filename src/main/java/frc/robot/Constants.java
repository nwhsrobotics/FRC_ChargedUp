...
public final class Constants {
    ...
    public static final class ModuleConstants {
        ...
        public static final double kDriveMotorGearRatio = (14.0 / 50.0) * (27.0 / 17.0) * (15.0 / 45.0); // (set up for
                                                                                                         // MK4(i) L2)
    ...
    public static final class DriveConstants {
        ...
        // left-to-right distance between the drivetrain wheels, should be measured from
        // center to center AND IN METERS
        public static final double kTrackWidth = 0.52;
        // front-back distance between drivetrain wheels, should be measured from center
        // to center AND IN METERS
        ...
        // FOR ALL OFFSETS: turn wheels until they become straight, replace with the
        // value of encoderss
        ...
        public static final double kPhysicalMaxSpeedMetersPerSecond = 6380.0 /
                60.0 *
                (ModuleConstants.kDriveMotorGearRatio) *
                ModuleConstants.kWheelDiameterMeters *
                Math.PI; // set up for NEOs to drive
        public static final double kPhysicalMaxAngularSpeedRadiansPerSecond = kPhysicalMaxSpeedMetersPerSecond /
                Math.hypot(
                        ...
                        DriveConstants.kWheelBase / 2.0); // adapted from SDS
    ...
    public static final class ShoulderConstants {
        ...
        public static final int ShoulderCanID20 = 21; // changed id from 3 to 20 to avoid conflicts with other id values
