...
// This is a copy-paste replacement of the Timer class from WPILib,
// to have "restart" method which was seemingly missing from the original implementation.
//
// There is likely a dependency issue causing the method to be missing,
// because clearly it exists in the source repository of WPILib.
